import { MyAccountSection } from '@/src/features/profile/my-account';
import {
    Modal,
    ModalBackdrop,
    ModalBody,
            ...
            <ModalContent className="bg-background-0 max-h-[90vh]">
                ...
                <ModalBody className="p-0 m-0">
                    <View className="flex-row flex-1">
                            ...
                            <ScrollView className="py-4">
                                ...
                                >
                                    <View className="flex-row items-center">
                                        <User
                                            size={18}
                                            className="text-typography-700 mr-2"
                                        />
                        ...
                        <View className="flex-1 bg-background-0">{renderContent()}</View>
                    </View>
                </ModalBody>
            </ModalContent>
        </Modal>
