import { ImageFile, ImageUploader } from '@/src/shared/ui/image-uploader';
...
import { uploadUserAvatar, uploadUserBanner } from '@/src/entities/upload';
                        ...
                        <View className="absolute -top-10 left-4 p-1 bg-gray-100 dark:bg-[#2f3136] rounded-full">
                            <Avatar size="xl">
                                {avatarImage?.uri || avatarUrl ? (
                                    <AvatarImage
                                        source={{ uri: avatarImage?.uri || avatarUrl }}
                                        alt={displayName}
                                    />
                                ) : (
                                    <AvatarFallbackText>
