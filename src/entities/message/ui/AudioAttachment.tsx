    ...
    <View className="my-2 bg-background-50 rounded-lg p-4 max-w-[300px]">
      ...
      <View className="flex-row items-center mb-3">
        ...
        <View className="flex-1">
          ...
          <Text className="text-xs text-typography-500">{formatFileSize(size)}</Text>
        </View>
      </View>
      ...
      <View className="flex-row items-center justify-between">
        <Text className="text-xs text-typography-500">{formatTime(currentTime)}</Text>
        ...
        <Text className="text-xs text-typography-500">{formatTime(duration)}</Text>
      </View>
    </View>
  );
}
